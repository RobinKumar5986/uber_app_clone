...
public class DriverMapActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnLogOutDriver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FirebaseAuth.getInstance().signOut();
                Toast.makeText(DriverMapActivity.this, "Sign Out Successfully", Toast.LENGTH_SHORT).show();
    ...
    protected void onStop() {
        ...
        try {
            ...
            if(currentUser.getCurrentUser()!=null){
                Log.d("Some User : ",currentUser.getCurrentUser().getUid());
            }else{
                Log.d("Some User : ","Null User");

            }
        }catch (Exception e){
            Log.d("Some User : ",e.getMessage());
...
//            GeoFire geoFire = new GeoFire(reference);
//            //under the userId, the child location is going to be stored
